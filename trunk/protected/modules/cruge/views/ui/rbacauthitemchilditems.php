...
echo "<div class='widget border-green' id='widget-button'>";
echo "<div class='widget-header bg-green'>";
echo "<h4 class='widget-title'><i class='aweso-key'></i> " . ucfirst($model->name) . " (" .
 CrugeTranslator::t($rbac->getAuthItemTypeName($model->type)) . ")</h4>";

echo "</div>";
echo "<div class='widget-content bg-white' data-scrollbar='mscroll'>";
echo "<div  style='height: 400px;overflow: auto;position: relative;'>";
