...
//array('label' => Yii::t('AweCrud.app', 'Update'), 'icon' => 'pencil', 'url' => array('update', 'id' => $model->idtipoSancion)),
...
<fieldset>
    <div class="row-fluid">
        <div class="span5">
			...
			'value'=>($model->sancionesIdsanciones !== null) ? CHtml::link($model->sancionesIdsanciones, array('/sanciones/view', 'idsanciones' => $model->sancionesIdsanciones->idsanciones)).' ' : null,
			'type' => 'html',
		),
                                        ),
                    )); ?>
